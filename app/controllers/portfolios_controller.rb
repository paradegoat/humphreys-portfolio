class PortfoliosController < ApplicationController
  ...
  def update
    ...
    respond_to do |format|
      if @portfolio_item.update(portfolio_params)
        format.html { redirect_to portfolio_index_path, notice: 'The record was successfully updated.' }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to portfolio_index_path, notice: 'Item was successfully destroyed.' }
    end
  end
